/* Q1 Write a query to return the email,first name,last name,& genre of all 
the Rock music listeners.Return your list ordered alphabetically by email starting with a
*/
...
/*Q3
   ...
   song length.Return the names and milliseconds for each track.Order by the 
